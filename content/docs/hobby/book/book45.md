...
*행복과 불행은 궤도의 이탈이라고 생각한다. 행복, 불행같은 추상적인 척도 대신에 재산, 사회적지위, 친구수, 자기관리 등 현실적인 수많은 수치들을 종합해봤을때 나에게 적절하다고 이미 정의된 수치가 있다고 가정하고. 특정 피쳐에서 그 최대/최소치를 넘어가면 갑자기 삶을 자각하게 되는것이다.
...
개나 고양이는 자살하지 않는다. 근데 인간만큼 행복하지도 않을것이다. 몇몇 매체에서 극단적인상황에 자살하는 침팬지나 돌고래 같은 사례가 나오는데? << 이 말에서 이미 인간으로서 극도의 행복과 불행을 느끼는게 왜 오류인지를 알수있음. 
