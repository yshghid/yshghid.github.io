...
2.3 BERT의 구조 [>>](https://yshghid.github.io/docs/study/cs/cs16/#23-bert%ec%9d%98-%ea%b5%ac%ec%a1%b0)

2.4 BERT 사전 학습 [>>](https://yshghid.github.io/docs/study/cs/cs16/#24-bert-%ec%82%ac%ec%a0%84-%ed%95%99%ec%8a%b5)
...
- 마스킹된 15%의 단어는 다음과 같은 비율로 변환된다.
  ...
  은 BERT의 입력으로 변환하면
  > "I love [MASK] learning because it is powerful."
  이고 모델의 목표는
  > "[MASK]" → "deep"
  이다.
