...
```python
#데이터 세트 생성
X,y = make_blobs(random_state=0, n_features=2, centers=3, cluster_std=1, n_samples=300)
df = pd.DataFrame(X)
plot_boundary(None, df[0], df[1], y, "df[0]", "df[1]")
```
![image](https://github.com/user-attachments/assets/52202861-67a2-4711-8612-eb984a72d9d4)
...
```plain text
정답률: 55.40571656996356 %
```
![image](https://github.com/user-attachments/assets/c64e35e5-8464-477d-ab37-1e38d0cd3b32)
