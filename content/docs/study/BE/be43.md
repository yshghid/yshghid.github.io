...
bookHidden: true
title: "Docker #4 자신의 Frontend 개발 코드를 컨테이너로 만들고 이것을 실행시켜 보자"
---

# Docker #4 자신의 Frontend 개발 코드를 컨테이너로 만들고 이것을 실행시켜 보자
...
2. default.conf는 사실 아래 코드로 바꿔넣어줬었다. index.html;을 추가한것임.
