...
bookHidden: true
title: "Bioinformatics Engineering #3 변이 Annotation"
pageHidden: true
---
...
임상적 해석을 위해 공개 데이터베이스 정보를 추가합니다.
...
gnomAD(Genome Aggregation Database)는 일반 인구에서의 변이 빈도를 제공합니다. 인구 집단의 1% 이상에서 발견되는 변이는 보통 질병 원인이 아닌 다형성(polymorphism)으로 간주합니다.
