...
> - 백신에 대한 면역 반응의 개인 간 변동성이 큼.
> - 요인1: HLA gene에서 발생하는 단일 뉴클레오타이드 변이(SNVs)
> - 요인2: 사이토카인, 사이토카인 수용체 및 선천 면역 반응에 관여하는 유전자
> - 연령, 성별, 동반 질환, 체질량 지수, 미량 영양소, 마이크로바이옴, 기존 면역과 같은 내적 요인과 흡연, 음주, 운동, 심리적 스트레스, 독소 노출과 같은 외적 요인이 포함됩니다.
> - 인종: 동일한 지역에 거주하는 다른 인종 집단이 백신에 대한 면역 반응이나 항체 감소에서 다양한 반응을 보임.
